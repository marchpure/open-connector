...
const allowedSecretKeys = new Set([
  ...
  "OPENCONNECTOR_OAUTH_UPSTREAM_PROMPT",
...
async function runMigration(secrets) {
  const child = spawn("/usr/local/bin/open-connector", ["migrate"], {
    cwd: "/app",
