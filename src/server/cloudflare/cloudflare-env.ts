...
export interface CloudflareEnv {
  ...
  OOMOL_CONNECT_JWKS_URI?: string;
  OOMOL_CONNECT_JWT_ISSUER?: string;
  OOMOL_CONNECT_JWT_AUDIENCE?: string;
  OOMOL_CONNECT_JWT_USER_POOL_REF?: string;
  OOMOL_CONNECT_JWT_SUBJECT_CLAIM?: string;
  OOMOL_CONNECT_JWT_GROUPS_CLAIM?: string;
  OOMOL_CONNECT_JWT_TENANT_CLAIM?: string;
  OOMOL_CONNECT_JWT_TENANT?: string;
