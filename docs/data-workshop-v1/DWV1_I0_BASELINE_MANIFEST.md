...
|---|---|---|---|---|---|
| Product | `marchpure/open-connector`, `git@github.com:marchpure/open-connector.git` | `codex/dwv1-i0-p0-baseline` | `9d5d4825e4cf079bca2f541e33bf312370f245a3` | same SHA verified on `fork/codex/dwv1-i0-p0-baseline` | clean independent worktree; code baseline is `e8251a3dd96af1af6692bb2e95217acf2745641d`, followed by manifest-only commits |
