...
|---|---|---|---|---|---|
| Product | `marchpure/open-connector`, `git@github.com:marchpure/open-connector.git` | `codex/dwv1-i0-p0-baseline` | `35a54cc437248ca920f5a999484e82ad34840684` | same SHA verified on `fork/codex/dwv1-i0-p0-baseline` | clean independent worktree; code baseline is `e8251a3dd96af1af6692bb2e95217acf2745641d`, followed by manifest-only commits |
...
this manifest is `35a54cc437248ca920f5a999484e82ad34840684`. W1 may edit only state, storage,
